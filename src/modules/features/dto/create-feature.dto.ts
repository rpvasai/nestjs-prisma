...
export class SignInFormDto {
  @ApiProperty({ description: 'Unique identifier for the SignIn form' })
  @IsString()
  readonly id: string;
  ...
  @ApiProperty({ description: 'Email field configuration in JSON format' })
  @IsJSON()
  readonly email: object;

  @ApiProperty({ description: 'Password field configuration in JSON format' })
  @IsJSON()
